-file("d:/erl8.1/lib/parsetools-2.1.3/include/leexinc.hrl", 0).
...
-file("d:/erl8.1/lib/parsetools-2.1.3/include/leexinc.hrl", 14).
...
-file("../../src/lexer.xrl", 74).
yyaction_16(TokenChars, TokenLine) ->
     { token, { comma, TokenLine, TokenChars } } .

-file("d:/erl8.1/lib/parsetools-2.1.3/include/leexinc.hrl", 290).
